...
class FruitRepository extends ServiceEntityRepository
{
    ...
    public function countFruits($name = null, $family = null): int
    {
        ...
        if ($name) $this->setWhere($qb, 'name', $name);
        if ($family) $this->setWhere($qb, 'family', $family);
    ...
    public function filterFruits($name, $family, $limit, $offset): array
    {
        $qb = $this->createQueryBuilder('f');
    ...
    private function setWhere(QueryBuilder $qb, string $name, string $value): void
    {
